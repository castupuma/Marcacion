...
<body class="hold-transition sidebar-mini sidebar-collapse">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <span class="btn  btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalForm" onclick="limpiarModal()">Agregar Usuario</span>


                </div>
                <!-- /.card-header -->

                <div class="panel-body table-responsive" id="listaservicio">
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="padding: 0.2rem">
          <h5 class="modal-title" id="exampleModalFormTitle" style="padding: 0.7rem">Registro de Usuario </h5>
          ...
          <form id="modalFormPlanilla">
            <div class="row">
              ...
              <div class="col-md-4 col-sm-12  form-group">
                <input type="text" placeholder="" class="form-control" disabled id="idusuario">
              </div>
             ...
             <div class="col-md-10 col-sm-12  form-group">
              ...
              <div class="col-md-10 col-sm-12  form-group">
                <input style="text-align: center; text-transform: uppercase;" placeholder="" id="nombres" name="nombres" class="form-control">
              ...
              <div class="col-md-10 col-sm-12  form-group">
                <input style="text-align: center; text-transform: uppercase;" maxlength="8" placeholder="" id="dni" name="dni" class="form-control">
              ...
              <div class="col-md-10 col-sm-12  form-group">
                <input style="text-align: center; text-transform: uppercase;"  placeholder="" id="contraseña" name="contraseña" class="form-control">
              ...
              <div class="col-md-10 col-sm-12  form-group">
                <input style="text-align: center; text-transform: uppercase;" placeholder="" id="foto" name="foto" class="form-control">
 ...
 -->
  ...
  <script src="../dist/js/bundlePerfiles.js"></script>
