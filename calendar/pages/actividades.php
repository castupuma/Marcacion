...
<body class="hold-transition sidebar-mini sidebar-collapse">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <span class="btn  btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalForm" onclick="limpiarModal()">Agregar Actividades</span>

                
                </div>
                <!-- /.card-header -->

                <div class="panel-body table-responsive" id="listadoactividades">
                  <table id="example1" class="table table-striped table-bordered table-condensed table-hover">
                    <thead>
                      <tr>
                        <th style="width:50px">Id Act.</th>
                        <th>Actividad</th>
                        <th>Puesto</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="padding: 0.2rem">
          <h5 class="modal-title" id="exampleModalFormTitle" style="padding: 0.7rem">Registro de Actividades </h5>
          ...
          <form id="modalFormPlanilla">
            <div class="row">
              ...
              <div class="col-md-2 col-sm-12  form-group ">
                <label class="col-form-label  ">Id Act.</label>
              </div>
              <div class="col-md-4 col-sm-12  form-group">
                <input type="text" placeholder="" class="form-control" disabled id="idactividades">
              </div>
              ...
              <div class="col-md-10 col-sm-12  form-group">
                <select id="servicio" name="puesto" class="select2">
                </select>
              </div>
  ...
  <script src="../dist/js/bundleActividades.js"></script>
