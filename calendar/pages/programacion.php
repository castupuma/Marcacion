...
<html>
  ...
  <body class="hold-transition sidebar-mini sidebar-collapse">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
        ...
        <form class="form-inline ml-3" style="margin-left: 0rem !important">
          ...
          <div class="col-md-4 col-sm-12  form-group">
            <select class="select2" style="width: 100%" name="cmbdepartamento" id="cmbdepartamento" onchange="listadoServicios(), cargarcalendar(), listadoPersonal()">
            ...
            <select
              ...
              class="select2"
              style="width: 100%"
              onchange="listadoPersonal(), cargarcalendar()"
            >
              <!-- <option selected="selected">Alabama</option> -->
            <!--   <option value="1">Auditoría Prestacional</option>
              <option value="2">Atención al Asegurado</option>
            ...
            <select
              ...
              style="width: 100%"
              onchange="cargarcalendar(), listadoPersonal()"
            >
              <!-- <option selected="selected">Alabama</option> -->
                ...
                <div class="row">
                  <div class="col-md-9">
                    <div class="card card-primary card-outline">
                      <div class="card-header">
                        <h4 class="card-title">
                          <i class="far fa-calendar-alt"></i> Calendario Registro Programación
                      ...
                      <div class="card-body" style="padding: 0.7rem">
                        ...
                        <div class="modal-footer">
                          ...
                          <button
                            ...
                            style="width: 100%"
                            onclick="RegistroHorarioProgramacion()"
                          >
                            Guardar
                          </button>
                        </div>
   ...
   <script src="../dist/js/app.js"></script>
    ...
    <script src="../dist/js/bundleProgramacion.js"></script> 
    <script>
      //Date range picker
