            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Relacion de Departamentos</h3> &nbsp; &nbsp;
                  <span class="btn  btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalForm" onclick="limpiarModal()">Agregar Departamento</span>

                  
                </div>
                <!-- /.card-header -->

                <div class="panel-body table-responsive" id="listasdepartamento">
                  <table id="example1" class="table table-striped table-bordered table-condensed table-hover">
                    <thead>
                      <tr>
                        <th style="width:50px">Id Dpto</th>
          ...
          <form id="modalFormPlanilla">
            <div class="row">
              ...
              <div class="col-md-2 col-sm-12  form-group ">
                <label class="col-form-label  ">Id Dpto</label>
              </div>
              ...
              <div class="col-md-10 col-sm-12  form-group">
                <select id="tipo" name="tipo" class="custom-select">
                  <option value="0">Unidad Organica</option>
