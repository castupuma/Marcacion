...
<body class="hold-transition sidebar-mini sidebar-collapse">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Reporte Actividades</h3> &nbsp; &nbsp;
              ...
              <!-- <option selected="selected">Alabama</option> -->
                   ...
                   <div class="input-group input-group-sm">
                    ...
                    <div class="col-md-2 col-sm-12  form-group">   
                      <select class="select2" style="width: 100%" name="cmbarea" id="cmbarea" onchange="listaPersonalActividad()" >
                      </select>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12  form-group">
                      <select class="select2" style="width: 100%" name="cmbpersonal" id="cmbpersonal">
                      </select>
                    </div>
                     ...
                     <div style="align-items: center;" class="item form-group">
                      <div class="col-md-12 col-sm-12  offset-md-5" >
                        <button type="button" class="btn btn-success " onclick="consultaReporteActividad()"><i class="fas fa-search"></i> Consultar</button>
                    ...
                    <table id="example2" class="table table-striped table-bordered table-condensed table-hover">
                      <thead>
                        <tr>
                          ...
                          <th style="width:50px">V.B Empleado</th>
                          <th style="width:50px">V.B Jefatura</th>
                        </tr>
                      </thead>
                      <tbody>
                      </tbody>
  ...
  <script src="../dist/js/bundleReporteActividad.js"></script>
