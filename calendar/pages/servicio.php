...
<body class="hold-transition sidebar-mini sidebar-collapse">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <span class="btn  btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalForm" onclick="limpiarModal()">Agregar Servicios</span>
                ...
                <div class="panel-body table-responsive" id="listaservicio">
                  <table id="example1" class="table table-striped table-bordered table-condensed table-hover">
                    <thead>
                      <tr>
                        <th style="width:50px">Id Serv</th>
                        <th>Descripcion</th>
                        <th>Dpto</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="padding: 0.2rem">
          <h5 class="modal-title" id="exampleModalFormTitle" style="padding: 0.7rem">Registro de Servicio </h5>
          ...
          <form id="modalFormPlanilla">
            <div class="row">
              ...
              <div class="col-md-2 col-sm-12  form-group ">
                <label class="col-form-label  ">Id Servicio</label>
              </div>
              <div class="col-md-4 col-sm-12  form-group">
                <input type="text" placeholder="" class="form-control" disabled id="idservicio">
              </div>
             ...
             <div class="col-md-10 col-sm-12  form-group">
                <select id="departamento" name="departamento" class="select2">
                </select>
              </div>
  ...
  <script src="../dist/js/bundleServicio.js"></script>
