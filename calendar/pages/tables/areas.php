...
<html>
  ...
  <body class="hold-transition sidebar-mini sidebar-collapse">
              ...
              <div class="col-md-10">
                ...
                <div class="card">
                    <div class="card-header">
                      ...
                      <span class="btn  btn-primary btn-sm"  data-toggle="modal"    data-target="#exampleModalForm" onclick="limpiarModal()">Agregar Area</span>
                      
                      <div class="card-tools">
                    
                        <div class="input-group input-group-sm" style="width: 300px;">
                          <input type="text" name="idfiltro" id="idfiltro" class="form-control float-right" placeholder="Buscar"  >

                          <div class="input-group-append">
                            <button type="submit" class="btn btn-default" onclick="listadoPlanilla()">
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" >
              ...
              <div class="row">
                  <div class="col-md-2 col-sm-12  form-group d-none">
                      <label class="col-form-label  ">Id puesto trabajo</label>
                    </div>
                    <div class="col-md-4 col-sm-12  form-group">
                    <input type="text" placeholder="" class="form-control" disabled id="idpuesto">
                    </div>
                    ...
                    <div class="col-md-10 col-sm-12  form-group">
                      <input list="listapersonal" style="text-align: center; text-transform: uppercase;"  placeholder="" id="puesto" name ="puesto" class="form-control" onblur="obteneridpersonal()">
    ...
    <script src="../dist/js/bundleMantenimiento.js"></script>
