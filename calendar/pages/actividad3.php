        ...
        <form class="form-inline ml-3" style="margin-left: 0rem !important">
           ...
           <div class="col-md-4 col-sm-12  form-group">
            <select
              ...
              class="select2"
              style="width: 100%"
              onchange="listadoServicios(), cargarcalendar(), listadoPersonal()"
            >
                ...
                <div class="row">
                  <div class="col-md-9">
                    <div class="card card-primary card-outline">
                      <div class="card-header">
                        <h4 class="card-title">
                          <i class="far fa-calendar-alt"></i> Calendario Registro de Actividades
