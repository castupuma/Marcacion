...
<body class="hold-transition sidebar-mini sidebar-collapse">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="panel-body table-responsive" id="listadoarea">
                  <table id="example1" class="table table-striped table-bordered table-condensed table-hover">
                    <thead>
                      <tr>
                        <th style="width:50px">Id Area</th>
                        <th>Nombre</th>
                        <th>Servicio</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="padding: 0.2rem">
          <h5 class="modal-title" id="exampleModalFormTitle" style="padding: 0.7rem">Registro de Area </h5>
          ...
          <form id="modalFormPlanilla">
            <div class="row">
              ...
              <div class="col-md-4 col-sm-12  form-group">
                <input type="text" placeholder="" class="form-control" disabled id="idarea">
              </div>
              ...
              <div class="col-md-10 col-sm-12  form-group">
                <select id="servicio" name="servicio" class="select2">
                </select>
              </div>
  ...
  <script src="../dist/js/bundleAreas.js"></script>
