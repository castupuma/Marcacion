...
function listadoActividades() {
  ...
  $.ajax({
    ...
    error: function () {
      alert("Ocurrio un error en el servidor ..listadoActividades");
    },
  });
...
function listadoActividadesId(idactividades){
  ...
  $.ajax({
    ...
    error: function () {
      alert("Ocurrio un error en el servidor. listadoActividadesId");
    },
  });
}
  ...
  function registrarActividades()
{
  ...
  var dat = JSON.stringify({
    ...
    $.ajax({
      ...
      error: function () {
        msgboxerror("Ocurrio un error en el servidor. registrarActividades");
      },
    });
  }  
