...
class seguridaDAO
{
    ...
    public function registrarSESSION($idusuario, $ip, $mac)
    {
        try {

            $database = new ConexionBD();

            $sql = " INSERT INTO sesion (idusuario, ip, mac, fechacrea) 
                      VALUES (:idusuario, :ip, :mac, now())  ";
    ...
    public function buscarUsuarioPorEmail($email)
    {
        try {
            ...
            $sql = " SELECT * FROM p_usuario WHERE dni = :email  ";
