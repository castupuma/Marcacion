...
if (is_array($data)) {
    ...
    switch ($tipoproceso) {
        case 1:
            $respuestaregisto = $mantenimientosDAO->obtenerPuestoTrabajo();
            $response['success'] = true;
            $response['mensaje'] = 'Consulta Exitosa';
            $response['dataResult'] = $respuestaregisto;   
            break;
        case 2:
            $respuestaregisto = $mantenimientosDAO->obtenerPuestoTrabajoid($param1);
            $response['success'] = true;
            $response['mensaje'] = 'Consulta Exitosa';
            $response['dataResult'] = $respuestaregisto;   
            break;
        ...
        case 3:
            $respuestaregisto = $mantenimientosDAO->registrarPuesto($param1,$param2,$param3);
            $response['success'] = true;
