...
if (is_array($data)) {
    ...
    switch ($tipoproceso) {
        case 1:
            $respuestaregisto = $servicioDAO->obtenerServicio();
            $response['success'] = true;
            $response['mensaje'] = 'Consulta Exitosa';
            $response['dataResult'] = $respuestaregisto;
            break;
        case 2:
            $respuestaregisto = $servicioDAO->obtenerServicioId($param1);
            $response['success'] = true;
            $response['mensaje'] = 'Consulta Exitosa';
            $response['dataResult'] = $respuestaregisto;
            break;
        case 3:
            $respuestaregisto = $servicioDAO->registrarServicio($param1, $param2, $param3, $param4);
            $response['success'] = true;
